...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <div className="w-full flex justify-start pl-3 pt-3  mb-5">
          <svg
            ...
            <div className="w-20 flex  ">
              ...
              <div>
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  class="size-8 ml-5 rounded-lg bg-orange-400 text-white"
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            <div className="w-20 flex ">
              ...
              <div>
                <svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  className="lucide lucide-scan-barcode rounded-lg bg-blue-500 text-white size-8 ml-5"
                >
                ...
                <div className="">Kiểm tra HSD</div>
              </div>
              </Link>
            </div>
            <div className="w-20 flex ">
